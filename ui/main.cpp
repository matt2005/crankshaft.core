...
int main(int argc, char* argv[]) {
  ...
  engine.rootContext()->setContextProperty("buildTimestamp", QString::fromUtf8(CRANKSHAFT_BUILD_TIMESTAMP));
  engine.rootContext()->setContextProperty("buildCommitShort", QString::fromUtf8(CRANKSHAFT_GIT_COMMIT_SHORT));
  engine.rootContext()->setContextProperty("buildCommitLong", QString::fromUtf8(CRANKSHAFT_GIT_COMMIT_LONG));
