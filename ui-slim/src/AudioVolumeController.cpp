...
auto AudioVolumeController::isMuted() const -> bool {
    return m_isMuted;
}
...
auto AudioVolumeController::getLastError() const -> QString {
    return m_lastError;
}
...
auto AudioVolumeController::handleAudioError(const QString& context, const QString& message) -> void {
