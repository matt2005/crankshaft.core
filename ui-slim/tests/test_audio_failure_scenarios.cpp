...
private slots:
    ...
    void testAudioBackendUnavailableOnStartup() {
        ...
        if (!audioAvailable) {
            ...
            QString userNotification =
                QStringLiteral("Audio unavailable - video projection active");
    ...
    void testErrorLogging() {
        ...
        QList<AudioError> errors = {
            ...
            {QStringLiteral("ALSA_DEVICE_NOT_FOUND"), QStringLiteral("No ALSA devices available"),
    ...
    void testAudioFeatureToggling() {
        ...
        auto updateAudioFeatures = [](bool audioAvailable) -> bool { return audioAvailable; };
    ...
    void cleanupTestCase() { qDebug() << "Audio Failure Scenarios test suite completed"; }
};
