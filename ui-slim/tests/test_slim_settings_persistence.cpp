...
class SlimSettingsPersistenceTest : public QObject {
  ...
  private slots:
    ...
    void testPercentageRangeValidation() {
        ...
        auto isValidPercentage = [](int value) {
    ...
    void testCorruptionDetectionLogic() {
        ...
        auto hasMissingKey = []() {
            QStringList requiredKeys = {
                QStringLiteral("slim_ui.display.brightness"),
        ...
        auto hasInvalidPercentage = [](int value) {
            return value < 0 || value > 100;
        };
    ...
    void cleanupTestCase() {
        qDebug() << "Settings Persistence test suite completed";
    }
};
